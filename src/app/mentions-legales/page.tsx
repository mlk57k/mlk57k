...
export default function MentionsLegalesPage() {
  return (
    ...
    >
      ...
      <p>
        Le site <strong>ancrage.xyz</strong> est édité par :
      </p>
      <ul>
        <li><strong>Dénomination sociale :</strong> Ancrage</li>
        <li>
          <strong>Adresse e-mail :</strong>{" "}
          <a href="mailto:contact@ancrage.xyz">contact@ancrage.xyz</a>
        </li>
        <li>
      ...
      <p>
        L&apos;ensemble des contenus présents sur le site ancrage.xyz (textes, images,
      ...
      <p>
        ...
        le signaler par e-mail à <a href="mailto:contact@ancrage.xyz">contact@ancrage.xyz</a>.
      </p>
      <p>
        <strong>
      ...
      <h2>9. Contact</h2>
      <p>
        Pour toute question : <a href="mailto:contact@ancrage.xyz">contact@ancrage.xyz</a>
      </p>
    </LegalPage>
  );
}
