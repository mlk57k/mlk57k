...
export default function PrivacyPage() {
  return (
    ...
    >
      ...
      <p>
        Ancrage est un compagnon de réflexion quotidienne accessible sur <strong>ancrage.app</strong>.
      ...
      <p>
        ...
        <a href="mailto:hello@ancrage.app">hello@ancrage.app</a>. Tu peux également adresser une
