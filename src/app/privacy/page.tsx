...
export default function PrivacyPage() {
  return (
    ...
    >
      ...
      <p>
        Ancrage est un compagnon de réflexion quotidienne accessible sur <strong>glowy.beauty</strong>.
      ...
      <p>
        ...
        <a href="mailto:hello@glowy.beauty">hello@glowy.beauty</a>. Tu peux également adresser une
